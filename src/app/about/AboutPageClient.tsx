        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 max-w-4xl mx-auto leading-relaxed">
              {content.heroSubtitle.split(' • ').map((part, index) => (
                <span key={index}>
                  {index > 0 && ' • '}
                  <span className="text-gradient font-semibold">{part}</span>
                </span>
              ))}
            </p>
          </motion.div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {content.education.map((edu, index) => (
                ...
                >
                  ...
                  <div className={`absolute inset-0 bg-gradient-to-br ${edu.gradient.replace('from-', 'from-').replace('to-', 'to-')}/50 translate-y-full group-hover:translate-y-0 transition-transform duration-500`} />
