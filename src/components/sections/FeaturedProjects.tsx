...
const featuredProjects: Project[] = [
  ...
  },
  {
    ...
    content: "",
    techStack: ["AI Analysis", "SEO Intelligence", "Performance Metrics", "Strategic Insights"],
    metrics: { custom1Label: "Starting Price", custom1Value: "Free", custom2Label: "Pro Plan", custom2Value: "$97", efficiency: "Real-time" },
  ...
  },
  {
    ...
    content: "",
    techStack: ["AI Generation", "Glassmorphic UI", "8 Templates", "Analytics Ready"],
    metrics: { custom1Label: "Build Time", custom1Value: "Minutes", custom2Label: "Unique Designs", custom2Value: "∞", efficiency: "Free" },
    category: "ai-tools",
